  ...
  return (
    <Drawer>
      <DrawerTrigger asChild>
        <Button variant={"ghost"} className="border border-slate-200 hover:bg-inherit hover:cursor-pointer hover:bg-slate-100 w-8 sm:w-12 ml-2 lg:hidden absolute top-4">
        <p>
  <svg
    width="45"
    height="65"
